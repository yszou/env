...
""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""""
"FONT BEAUTIFIERS:
syn match   t2tItalic       '\(//\|\*\)\S\(\|.\{-}\S\)\(//\|\*\)\+'hs=s+0,he=e-0
syn match   t2tBold         '\*\*\S\(\|.\{-}\S\)\*\*\+'hs=s+0,he=e-0
syn match   t2tMath         '$\s*\S\(\|.\{-}\S\)\s*$\+'hs=s+0,he=e-0
syn match   t2tUnderline    '__\S\(\|.\{-}\S\)__\+'hs=s+0,he=e-0
syn match   t2tStrike       '--\S\(\|.\{-}\S\)--\+'hs=s+0,he=e-0
syn match   t2tMonospace    '``\S\(\|.\{-}\S\)``\+'hs=s+0,he=e-0
syn match   t2tRaw          '""\S\(\|.\{-}\S\)""\+'hs=s+0,he=e-0
syn match   t2tTagged       "''\S\(\|.\{-}\S\)''\+"hs=s+0,he=e-0
syn match   t2tVerb1Line     '^``` .*$'hs=s+0
syn match   t2tRaw1Line      '^""" .*$'hs=s+0
syn match   t2tTagged1Line   "^''' .*$"hs=s+0
syn region  t2tVerbArea     start='^```.\{-}\s*$'hs=s+0 end='^```\s*$'he=e-0
syn region  t2tRawArea      start='^"""\s*$'hs=s+0 end='^"""\s*$'he=e-0
syn region  t2tTaggedArea   start="^'''\s*$"hs=s+0 end="^'''\s*$"he=e-0
syn region  t2tMathArea     start="^\\\[\s*$"hs=s+0 end="^\\\]\s*$"he=e-0
syn region  t2tMathArea2     start="^$$\s*$"hs=s+0 end="^$$\s*$"he=e-0
...
hi default link t2t_Verb       Operator
hi default link t2t_Raw        String
hi default link t2t_Tagged     Special
"

hi def Orange term=underline ctermfg=10 guifg=#E59710
hi def MyTitle term=bold ctermbg=1 guibg=NONE guifg=#FFFA00


" color definitions (specific)
hi default link t2tBar     WarningMsg
hi default t2tBar         term=bold        cterm=bold        gui=bold
hi default link t2tBold     Title
hi default t2tBold        term=bold        cterm=bold        gui=bold
hi default link t2tMath t2tBold
hi default link t2tMathArea t2tMath
hi default link t2tMathArea2 t2tMath
hi default link t2tItalic     Orange
hi default t2tItalic      term=italic      cterm=italic      gui=italic
hi default t2tStrike      term=italic      cterm=italic      gui=undercurl guisp=Red
hi default t2tUnderline   term=underline   cterm=underline   gui=underline
hi default link t2tQuote       String
...
hi default link t2tTitle         MyTitle
hi default link t2tNumTitle      MyTitle
" comment the following line to avoid having trailing whitespaces in red
hi default link t2tBlank         DiffAdd
...
hi default link t2tList          WarningMsg
hi default link t2tMacro         t2t_Component
hi default link t2tTitleMark     MyTitle
