...
function s:Init()
    ...
    if !exists('g:table')
        ...
        "起始字母的在码表中的开始行
        let g:charFirst = [1, 4256, 6310, 8178, 12337, 14342, 18739, 23468, 25360, 30176, 33018, 36015, 38565, 41006, 44164, 45962, 48997, 53363, 58594, 62142, 67295, 71545, 73817, 78453, 81169, 85567]
        "a=97 y=121
    endif
